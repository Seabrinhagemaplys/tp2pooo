...
class Peao(Peca):
    ...
    def atualizar_lista_de_possiveis_coordenadas(self):
        ...
        match self.cor:
            case ut.EnumCor.BRANCO:
                self.atualizar_lista_de_possiveis_coordenadas_peao_branco(linha_atual, coluna_atual)
            
            case ut.EnumCor.PRETO:
                self.atualizar_lista_de_possiveis_coordenadas_peao_preto(linha_atual, coluna_atual)
            
            case _:
                pass

    def atualizar_lista_de_possiveis_coordenadas_peao_branco(self, linha_atual, coluna_atual):
    ...
    def atualizar_lista_de_possiveis_coordenadas_peao_preto(self, linha_atual, coluna_atual):
        self.tentar_adicionar(linha_atual + 1, coluna_atual)
        if not self.ja_movimentou:
            self.tentar_adicionar(linha_atual + 2, coluna_atual)
